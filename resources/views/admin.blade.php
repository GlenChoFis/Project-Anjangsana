										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													@if($d->status_pesan != 2)
													<td><a type="button" class="btn btn-light" style="border: 1px solid #ccc" href="/cek/{{$d->id_perizinan}}" class>Cek</a></td>  
													@else
													<td><a type="button" style="pointer-events: none" class="btn btn-danger" readonly>Pesanan Dibatalkan</a></td>
													@endif                         
												</tr>
												@endforeach
											</tbody>
