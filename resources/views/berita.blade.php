					...
					<div id="main">
						...
						<!-- Post -->
							<section class="post">
								...
								@foreach($data as $d)
								<div>
									<p><h2><a href="/berita/{{$d->judul}}">{{$d->judul}}</a></h2></p>
								</div>
								<div class="image main" style="margin-bottom:20px; margin-top:20px">
									<figure>
										<img src="storage/{{$d->image_berita}}" alt="" />
										<figcaption>{{$d->caption}}</figcaption>
									</figure>
								</div>
								<!-- <p style="text-indent: 0.4in">{{$d->isi}}</p> -->
								@endforeach
							</section>
